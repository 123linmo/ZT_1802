...
public class Shili_input {
	...
	public static void main(String[] args) throws Exception {
		//读取目标文件并将数据写入目标文件
		FileInputStream shilishuju_source=new FileInputStream("E:\\JAVA\\1120\\shili.xlsx");
		...
		//读取目标文件并将数据写入目标文件
		FileInputStream shilishuju_dest=new FileInputStream("E:\\JAVA\\1120\\18rj2.xlsx");
		...
		for (int i = 1; i <= rows_dest; i++) {
			...
			//读取
			String xuehao=rowi_dest.getCell(3).getStringCellValue();//n表示第几列
		...
		FileOutputStream shilishujushuchu_dest = new FileOutputStream("E:\\\\JAVA\\\\1120\\\\18rj2.xlsx");
